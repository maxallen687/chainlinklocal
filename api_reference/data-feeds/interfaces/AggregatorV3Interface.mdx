...
_Provides methods to get the latest data, historical data for specific rounds, and metadata such as decimals and description._
...
_This function should raise "No data present" if no data is available for the given round ID._
